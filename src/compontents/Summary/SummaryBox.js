...
export const SummaryBox = (props) => {
    const {numberOfQuizzes, section} = props;
    ...
    if (localStorage.getItem(`${props.subject}${section}`)) {
        return (
            <div className="summary-panel__content">
                <div className="summary-info">
                    ...
                    <p className='summary-info__number-of-quizzes'>Number of quizzes : <span>{numberOfQuizzes}</span>
                    </p>
        ...
        <div className="summary-panel__content nodata">
            <div className="summary-info">
                <p className="summary-info__heading">
                    Section : <span>{section}</span>
                </p>
                <p className='summary-info__number-of-quizzes'>Number of quizzes : <span>-</span></p>
                ...
                <div className="summary-info__data">
                    <p className="summary-info__data--percent">
                        percentage of correct answers : <br/> <span>-</span>
                    </p>
                    <p className="summary-info__data-average">
                        average number of correct answers per quiz : <br/> <span>-</span>
                    </p>
                </div>
            </div>
        </div>
